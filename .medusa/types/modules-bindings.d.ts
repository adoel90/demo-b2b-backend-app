...
import type Approval from '../../modules/approval'
...
declare module '@medusajs/framework/types' {
  interface ModuleImplementations {
    ...
    'company': InstanceType<(typeof Company)['service']>,
    'quote': InstanceType<(typeof Quote)['service']>,
    'approval': InstanceType<(typeof Approval)['service']>
  }
}