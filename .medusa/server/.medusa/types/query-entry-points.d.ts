...
export type CompanySpendingLimitResetFrequencyEnum =
  | 'never'
  | 'daily'
  | 'weekly'
  | 'monthly'
...
export type Company = {
  ...
  spending_limit_reset_frequency: CompanySpendingLimitResetFrequencyEnum;
  employees: Array<Maybe<Employee>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  approval_settings_link: Maybe<LinkCompanyCompanyApprovalApprovalSettings>;
  approval_settings: Maybe<ApprovalSettings>;
  cart_link: Maybe<Array<Maybe<LinkCompanyCompanyCartCart>>>;
  carts: Maybe<Array<Maybe<Cart>>>;
  customer_group_link: Maybe<LinkCompanyCompanyCustomerCustomerGroup>;
  customer_group: Maybe<CustomerGroup>;
  order_link: Maybe<LinkOrderOrderCompanyCompany>;
  order: Maybe<Order>;
};
...
export type Employee = {
  __typename?: 'Employee';
  id: Scalars['ID']['output'];
  spending_limit: Scalars['Float']['output'];
  is_admin: Scalars['Boolean']['output'];
  company_id: Scalars['String']['output'];
  company: Company;
  raw_spending_limit: Scalars['JSON']['output'];
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  customer_link: Maybe<LinkCompanyEmployeeCustomerCustomer>;
...
export type Quote = {
  ...
  draft_order_id: Scalars['String']['output'];
  order_change_id: Scalars['String']['output'];
...
export type Approval = {
  ...
  created_by: Scalars['String']['output'];
  handled_by: Maybe<Scalars['String']['output']>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  cart_link: Maybe<LinkCartCartApprovalApproval>;
  cart: Maybe<Cart>;
};
...
export type ApprovalSettings = {
  ...
  id: Scalars['ID']['output'];
  company_id: Scalars['String']['output'];
  requires_admin_approval: Scalars['Boolean']['output'];
  requires_sales_manager_approval: Scalars['Boolean']['output'];
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  company_link: Maybe<LinkCompanyCompanyApprovalApprovalSettings>;
  company: Maybe<Company>;
};

export type ApprovalStatusStatusEnum =
  | 'pending'
  | 'approved'
  | 'rejected';
...
export type ApprovalStatus = {
  ...
  id: Scalars['ID']['output'];
  cart_id: Scalars['String']['output'];
  status: ApprovalStatusStatusEnum;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  cart_link: Maybe<LinkCartCartApprovalApprovalStatus>;
  cart: Maybe<Cart>;
};
...
export type CustomerGroup = {
  ...
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
  company_link: Maybe<LinkCompanyCompanyCustomerCustomerGroup>;
  company: Maybe<Company>;
};
...
export type Customer = {
  ...
  employee_link: Maybe<LinkCompanyEmployeeCustomerCustomer>;
...
export type Cart = {
  ...
  order: Maybe<Order>;
  approval_status_link: Maybe<LinkCartCartApprovalApprovalStatus>;
  approval_status: Maybe<ApprovalStatus>;
  approval_link: Maybe<Array<Maybe<LinkCartCartApprovalApproval>>>;
  approvals: Maybe<Array<Maybe<Approval>>>;
  company_link: Maybe<LinkCompanyCompanyCartCart>;
  company: Maybe<Company>;
};
...
export type Order = {
  ...
  company_link: Maybe<LinkOrderOrderCompanyCompany>;
  company: Maybe<Company>;
};
...
export type LinkCartCartApprovalApprovalStatus = {
  __typename?: 'LinkCartCartApprovalApprovalStatus';
  cart_id: Scalars['String']['output'];
  approval_status_id: Scalars['String']['output'];
  cart: Maybe<Cart>;
  approval_status: Maybe<ApprovalStatus>;
  createdAt: Scalars['String']['output'];
  updatedAt: Scalars['String']['output'];
...
export type LinkCartCartApprovalApproval = {
  __typename?: 'LinkCartCartApprovalApproval';
  cart_id: Scalars['String']['output'];
  approval_id: Scalars['String']['output'];
  cart: Maybe<Cart>;
...
export type LinkCompanyCompanyApprovalApprovalSettings = {
  __typename?: 'LinkCompanyCompanyApprovalApprovalSettings';
  company_id: Scalars['String']['output'];
  approval_settings_id: Scalars['String']['output'];
  company: Maybe<Company>;
  approval_settings: Maybe<ApprovalSettings>;
  createdAt: Scalars['String']['output'];
  updatedAt: Scalars['String']['output'];
...
export type LinkCompanyCompanyCartCart = {
  __typename?: 'LinkCompanyCompanyCartCart';
  company_id: Scalars['String']['output'];
  cart_id: Scalars['String']['output'];
  company: Maybe<Company>;
  cart: Maybe<Cart>;
...
export type LinkCompanyCompanyCustomerCustomerGroup = {
  __typename?: 'LinkCompanyCompanyCustomerCustomerGroup';
  company_id: Scalars['String']['output'];
  customer_group_id: Scalars['String']['output'];
  company: Maybe<Company>;
  customer_group: Maybe<CustomerGroup>;
...
export type LinkCompanyEmployeeCustomerCustomer = {
  __typename?: 'LinkCompanyEmployeeCustomerCustomer';
...
export type LinkOrderOrderCompanyCompany = {
  __typename?: 'LinkOrderOrderCompanyCompany';
  order_id: Scalars['String']['output'];
  company_id: Scalars['String']['output'];
  order: Maybe<Order>;
  company: Maybe<Company>;
...
declare module '@medusajs/framework/types' {
  interface RemoteQueryEntryPoints {
    ...
    cart_approval_status: LinkCartCartApprovalApprovalStatus
    cart_approval: LinkCartCartApprovalApproval
    company_approval_settings: LinkCompanyCompanyApprovalApprovalSettings
    company_cart: LinkCompanyCompanyCartCart
    company_customer_group: LinkCompanyCompanyCustomerCustomerGroup
    employee_customer: LinkCompanyEmployeeCustomerCustomer
    order_company: LinkOrderOrderCompanyCompany
  }
}